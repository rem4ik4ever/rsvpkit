...
export function useAuthenticatedItemQuery(options?: Omit<Urql.UseQueryArgs<AuthenticatedItemQueryVariables>, 'query'>) {
  return Urql.useQuery<AuthenticatedItemQuery, AuthenticatedItemQueryVariables>({ query: AuthenticatedItemDocument, ...options });
};
